  ...
  return (
    <section className="animate-fade-in-up">
      ...
      <p className="text-xs text-gray-500 mt-8 italic">
        portfolio inspired by <a href="https://nexxel.dev" className="hover:text-accent transition-colors duration-200" target="_blank" rel="noopener noreferrer">nexxel.dev</a>
      </p>
    </section>
  )
}
